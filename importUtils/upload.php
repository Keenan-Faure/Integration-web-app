...
if(isset($_POST['submit']))
{
    ...
    if($file->fileName != null)
    {
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) 
        {
            ...
            $conn->createHtmlMessages('File Upload', 'File has been uploaded successfully', '../ImportUtils/import.html', 'info');
...
{
    $conn->createHtmlMessages('File Upload', 'Unknown error occurred, please try again', '../ImportUtils/import.html', 'info');
    header('Refresh:2,url=import.html');
    exit();
}
